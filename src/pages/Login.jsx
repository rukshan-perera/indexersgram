...
const Login = () => {
  ...
  return (
    <>
      <div className="h-screen w-screen flex flex-wrap items-center justify-center p-3 loginBg">
        <div className="flex items-center">
          <div className="hidden md:block">
            <img
              src="/images/login-side-img.jpg"
              className="max-h-[500px] mr-5"
              alt="login"
            />
          </div>
            ...
            <div className="flex flex-col items-center justify-center rounded w-full border-[1px] border-gray-300 bg-white p-6">
              <div className="w-full">
                <img
                  ...
                  className="mt-4 mb-4 p-5 mx-auto my-3"
                  alt="instagram"
                />
              </div>
